...
var onlyStock = !1, scanner = function() {
        ...
        if (B.match(/automated access|api-services-support@/)) {
          ...
          if (B.match(/ref=cs_503_link/)) {
            ...
            if (l.scrapeFilters && 0 < l.scrapeFilters.length) {
              n = {};
              t = null;
              var y = "", f = null, x = {}, u = {}, I = !1, w = function(a, b, e) {
                var h = [];
                if (!a.selector) {
                  if (!a.regExp) {
              ...
              for (r in l.scrapeFilters) {
                b.$jscomp$loop$prop$pageType$72 = r;
                a: {
                  if (a) {
                    break;
                  }
                  b.$jscomp$loop$prop$pageFilter$69 = l.scrapeFilters[b.$jscomp$loop$prop$pageType$72];
                  var k = b.$jscomp$loop$prop$pageFilter$69.pageVersionTest, h = document.querySelectorAll(k.selector);
                  ...
                  if (0 != h.length) {
                    ...
                    t = b.$jscomp$loop$prop$pageType$72;
                    h = {};
                    for (var d in b.$jscomp$loop$prop$pageFilter$69) {
                      if (a) {
                        break;
                      }
                      h.$jscomp$loop$prop$sel$65 = b.$jscomp$loop$prop$pageFilter$69[d];
                      if (h.$jscomp$loop$prop$sel$65.name != k.name) {
                        if (h.$jscomp$loop$prop$sel$65.parentList) {
                          e = [];
                          if ("undefined" != typeof x[h.$jscomp$loop$prop$sel$65.parentList]) {
                            e = x[h.$jscomp$loop$prop$sel$65.parentList];
                          } else {
                            if (!0 === w(b.$jscomp$loop$prop$pageFilter$69[h.$jscomp$loop$prop$sel$65.parentList], B, b.$jscomp$loop$prop$pageType$72)) {
                              e = x[h.$jscomp$loop$prop$sel$65.parentList];
                            } else {
                              break;
                            }
                          }
                          u[h.$jscomp$loop$prop$sel$65.parentList] || (u[h.$jscomp$loop$prop$sel$65.parentList] = []);
                          var C = 0, v = {}, z;
                          for (z in e) {
                            if (a) {
                              break;
                            ...
                            if (e.hasOwnProperty(z)) {
                              if ("lager" == h.$jscomp$loop$prop$sel$65.name) {
                                C++;
                                try {
                                  var m = void 0, p = void 0;
                                  h.$jscomp$loop$prop$sel$65.selector && (m = e[z].querySelector(h.$jscomp$loop$prop$sel$65.selector));
                                  h.$jscomp$loop$prop$sel$65.altSelector && (p = e[z].querySelector(h.$jscomp$loop$prop$sel$65.altSelector));
                                  p && (p = p.getAttribute(h.$jscomp$loop$prop$sel$65.attribute));
                                  var D = 999, M = !1;
                                  try {
                                    M = -1 != e[z].textContent.toLowerCase().indexOf("add to cart to see product details.");
                                  } catch (J) {
                                  }
                                  if (!p) {
                                    try {
                                      var F = JSON.parse(h.$jscomp$loop$prop$sel$65.regExp);
                                      if (F.sel1) {
                                        try {
                                          var Q = JSON.parse(e[z].querySelectorAll(F.sel1)[0].dataset[F.dataSet1]);
                                          p = Q[F.val1];
                                          D = Q.maxQty;
                                        } catch (J) {
                                        }
                                      ...
                                      if (!p && F.sel2) {
                                        try {
                                          var R = JSON.parse(e[z].querySelectorAll(F.sel2)[0].dataset[F.dataSet2]);
                                          p = R[F.val2];
                                          D = R.maxQty;
                                        } catch (J) {
                                        }
                                  ...
                                  if (m) {
                                    A++;
                                    v.$jscomp$loop$prop$mapIndex$66 = z + "";
                                    v.$jscomp$loop$prop$busy$67 = !0;
                                    var G = document.location.href.match(/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/)[1];
                                    G = G[1];
                                    null == G || 9 > G.length || (chrome.runtime.sendMessage({type:"getStock", asin:G, oid:p, maxQty:D, isMAP:M, host:document.location.hostname, referer:document.location + "", domainId:l.domainId, force:!0, session:"unknown"}, function(a, b) {
                                      return function(d) {
                                        a.$jscomp$loop$prop$busy$67 && (a.$jscomp$loop$prop$busy$67 = !1, "undefined" != typeof d && (d.error ? console.log(d.error) : (u[b.$jscomp$loop$prop$sel$65.parentList][a.$jscomp$loop$prop$mapIndex$66][b.$jscomp$loop$prop$sel$65.name] = d, 0 == --A && g(q))));
                                      };
                                    }(v, h)), setTimeout(function(a) {
                                      return function() {
                                        a.$jscomp$loop$prop$busy$67 && 0 == --A && (a.$jscomp$loop$prop$busy$67 = !1, g(q));
                                      };
                                    }(v), 3000));
                                  }
                                } catch (J) {
                                ...
                                if ("revealMAP" == h.$jscomp$loop$prop$sel$65.name) {
                                  v.$jscomp$loop$prop$revealMAP$70 = h.$jscomp$loop$prop$sel$65, m = void 0, m = v.$jscomp$loop$prop$revealMAP$70.selector ? e[z].querySelector(v.$jscomp$loop$prop$revealMAP$70.selector) : e[z], null != m && m.textContent.match(new RegExp(v.$jscomp$loop$prop$revealMAP$70.regExp, "i")) && (m = document.location.href.match(/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/), m = m[1], p = b.$jscomp$loop$prop$pageFilter$69.sellerId, "undefined" == typeof p || null == p || null == m || 
                                  2 > m.length || (p = e[z].querySelector('input[name="oid"]').value, null == p || 20 > p + 0 || (m = v.$jscomp$loop$prop$revealMAP$70.altSelector.replace("OFFERID", p).replace("ASINID", m), A++, v.$jscomp$loop$prop$mapIndex$14$71 = z + "", c(m, "GET", null, 3000, function(a, b) {
                                    return function(d) {
                                      if (4 == d.readyState) {
                                        A--;
                                        if (200 == d.status) {
                                          try {
                                            var e = d.responseText, h = a.$jscomp$loop$prop$pageFilter$69.price;
                                            if (h && h.regExp) {
                                              if (e.match(/no valid offer--/)) {
                                                u[b.$jscomp$loop$prop$revealMAP$70.parentList][b.$jscomp$loop$prop$mapIndex$14$71] || (u[b.$jscomp$loop$prop$revealMAP$70.parentList][b.$jscomp$loop$prop$mapIndex$14$71] = {}), u[b.$jscomp$loop$prop$revealMAP$70.parentList][b.$jscomp$loop$prop$mapIndex$14$71][b.$jscomp$loop$prop$revealMAP$70.name] = -1;
                                              } else {
                                                var r = e.match(new RegExp("price info--\x3e(?:.|\\n)*?" + h.regExp + "(?:.|\\n)*?\x3c!--")), k = e.match(/price info--\x3e(?:.|\n)*?(?:<span.*?size-small.*?">)([^]*?<\/span)(?:.|\n)*?\x3c!--/);
                                                if (!r || r.length < h.reGroup) {
                                                  f += " //  priceMAP regexp fail: " + (e + " - " + h.name + a.$jscomp$loop$prop$pageType$72);
                                                } else {
                                                  var c = r[h.reGroup];
                                                  u[b.$jscomp$loop$prop$revealMAP$70.parentList][b.$jscomp$loop$prop$mapIndex$14$71] || (u[b.$jscomp$loop$prop$revealMAP$70.parentList][b.$jscomp$loop$prop$mapIndex$14$71] = {});
                                                  u[b.$jscomp$loop$prop$revealMAP$70.parentList][b.$jscomp$loop$prop$mapIndex$14$71][b.$jscomp$loop$prop$revealMAP$70.name] = c;
                                                  null != k && 2 == k.length && (u[b.$jscomp$loop$prop$revealMAP$70.parentList][b.$jscomp$loop$prop$mapIndex$14$71][b.$jscomp$loop$prop$revealMAP$70.name + "Shipping"] = k[1].replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                                                }
                                              }
                                            }
                                          } catch (U) {
                                  ...
                                  m = w(h.$jscomp$loop$prop$sel$65, e[z], b.$jscomp$loop$prop$pageType$72);
                                  if (!1 === m) {
                                    a = !0;
                                    break;
                                  }
                                  if (!0 !== m) {
                                    if (u[h.$jscomp$loop$prop$sel$65.parentList][z] || (u[h.$jscomp$loop$prop$sel$65.parentList][z] = {}), h.$jscomp$loop$prop$sel$65.multiple) {
                                      for (var K in m) {
                                        m.hasOwnProperty(K) && !h.$jscomp$loop$prop$sel$65.keepBR && (m[K] = m[K].replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                                      }
                                      m = m.join("\u271c\u271c");
                                      u[h.$jscomp$loop$prop$sel$65.parentList][z][h.$jscomp$loop$prop$sel$65.name] = m;
                                    } else {
                                      u[h.$jscomp$loop$prop$sel$65.parentList][z][h.$jscomp$loop$prop$sel$65.name] = h.$jscomp$loop$prop$sel$65.keepBR ? m : m.replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " ");
                                    }
                                  }
                                }
                              }
                            }
                            v = {$jscomp$loop$prop$busy$67:v.$jscomp$loop$prop$busy$67, $jscomp$loop$prop$mapIndex$66:v.$jscomp$loop$prop$mapIndex$66, $jscomp$loop$prop$revealMAP$70:v.$jscomp$loop$prop$revealMAP$70, $jscomp$loop$prop$mapIndex$14$71:v.$jscomp$loop$prop$mapIndex$14$71};
                          }
                        } else {
                          e = w(h.$jscomp$loop$prop$sel$65, B, b.$jscomp$loop$prop$pageType$72);
                          if (!1 === e) {
                            a = !0;
                            break;
                          }
                          if (!0 !== e) {
                            if (h.$jscomp$loop$prop$sel$65.multiple) {
                              for (var N in e) {
                                e.hasOwnProperty(N) && !h.$jscomp$loop$prop$sel$65.keepBR && (e[N] = e[N].replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                              }
                              e = e.join();
                            } else {
                              h.$jscomp$loop$prop$sel$65.keepBR || (e = e.replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                            }
                            n[h.$jscomp$loop$prop$sel$65.name] = e;
                          }
                        }
                      }
                      h = {$jscomp$loop$prop$sel$65:h.$jscomp$loop$prop$sel$65};
                    }
                    a = !0;
                  }
                }
                b = {$jscomp$loop$prop$pageFilter$69:b.$jscomp$loop$prop$pageFilter$69, $jscomp$loop$prop$pageType$72:b.$jscomp$loop$prop$pageType$72};
              }
              if (null == t) {
  ...
  window.addEventListener("error", function(c, g, n, E, H) {
  ...
  if (!window.keepaHasRun) {
    ...
    var f = {domain:0, iframeStorage:null, ASIN:null, tld:"", placeholder:"", cssFlex:function() {
              ...
              if ((e || "com" == f.tld) && !f.revealWorking) {
                if (f.revealWorking = !0, document.getElementById("keepaMAP")) {
                  ...
                  var d = function() {
                      ...
                      if (d || r) {
                        ...
                        var v = function(a) {
                          ...
                          if (null != b) {
                            ...
                            r && (a = f.revealCache[e].stock, 999 == a ? a = "999+" : 1000 == a ? a = "1000+" : f.revealCache[e].isMaxQty && 30 == a && (a += "+"), h = document.createElement("span"), h.style = "font-weight: bold;", h.innerText = a + " ", a = document.createElement("span"), a.style = "color: #dedede;", a.innerText = " (revealed by \u271c Keepa)", c = document.createElement("span"), c.style = "color:#da4c33;", c.innerText = " order limit", b.appendChild(h), f.revealCache[e].limit && 
                            (0 < f.revealCache[e].orderLimit && (c.innerText += ": " + f.revealCache[e].orderLimit), b.appendChild(c)), k && b.appendChild(a));
                          }
                        };
                        "undefined" != typeof f.revealCache[e] && -1 != f.revealCache[e] ? "pending" != f.revealCache[e] && v(f.revealCache[e]) : (f.revealCache[e] = "pending", chrome.runtime.sendMessage({type:"getStock", asin:b, oid:e, sellerId:g, maxQty:m, isMAP:d, host:document.location.hostname, force:d, referer:document.location + "", domainId:f.domain, cachedStock:f.revealCache[g], session:h}, function(a) {
                    ...
                    try {
                      var e = document.querySelectorAll("#aod-offer,#aod-pinned-offer");
                      if (null != e && 0 != e.length) {
                        a = null;
                        var d = e[0].querySelector('input[name="session-id"]');
                        if (d) {
                      ...
                      console.log(O), f.reportBug(O, "MAP error: " + g);
                    }
                  });
                  ...
                  window.onunload = function L() {
                    try {
                      window.detachEvent("onunload", L), m.disconnect();
                    } catch (T) {
                    }
                  };
                  var p = document.querySelector("#newAccordionRow #offerListingID, #newAccordionRow_0 #offerListingID, #newAccordionRow_1 #offerListingID, #qualifiedBuybox #offerListingID, #exportsBuybox #offerListingID");
                  a = null;
                  if (b) {
                  ...
                  if (null != p && null != p.value) {
                    var q = p.parentElement.querySelector("#session-id"), t = p.parentElement.querySelector("#ASIN"), w = p.parentElement.querySelector("#selectQuantity #quantity > option:last-child");
                    if (null != q && null != t) {
                      for (n = 0; n < b.mainEl.length; n++) {
                        var x = document.querySelector(b.mainEl[n]);
                        if (null != x) {
                          n = !1;
                          if (null != w) {
                            try {
                          ...
                          h(x, t.value, !1, p.value, q.value, !1, n, a);
                          break;
                        }
                      }
                    }
                  ...
                  if (null != u && /(our price|always remove it|add this item to your cart|see product details in cart|see price in cart)/i.test(u.textContent)) {
                    var y = document.getElementById("merchant-info");
                    q = p = "";
                    if (y) {
                      if (-1 == y.textContent.toLowerCase().indexOf("amazon.c")) {
                        var A = u.querySelector('span[data-action="a-modal"]');
                        if (A) {
                          var B = A.getAttribute("data-a-modal");
                          B.match(/offeringID\.1=(.*?)&amp/) && (p = RegExp.$1);
                        }
                        if (0 == p.length) {
                          if (B.match('map_help_pop_(.*?)"')) {
                            q = RegExp.$1;
                          } else {
                            f.revealWorking = !1;
                            return;
                      ...
                      if (null != p && 10 < p.length) {
                        var E = document.querySelector("#session-id");
                        h(u, f.ASIN, !1, p, E.value, !1, !1, q);
                      }
                    } else {
                      f.revealWorking = !1;
                    }
      ...
      if (!(6E5 > k - f.lastBugReport || /(dead object)|(Script error)|(\.location is null)/i.test(a))) {
        ...
        null != c.url && c.url.startsWith("blob:") || (c.keepaType = E ? "keepaChrome" : g ? "keepaOpera" : q ? "keepaSafari" : t ? "keepaEdge" : "keepaFirefox", c.version = B, chrome.storage.local.get("token", function(a) {
    ...
    if (window.self == window.top && (document.addEventListener("DOMContentLoaded", function(a) {
      ...
      var x = document.location.href, u = !1;
      document.addEventListener("DOMContentLoaded", function(a) {
        if (!u) {
          try {
            if (x.startsWith("https://test.keepa.com") || x.startsWith("https://keepa.com")) {
      ...
      var I = !1;
      x.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|nl|in|com\.mx|com\.br|com\.au)\/s\?/) ? (onlyStock = !0, f.onPageLoad()) : /((\/images)|(\/review)|(\/customer-reviews)|(ask\/questions)|(\/product-reviews))/.test(x) || /\/e\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/.test(x) || !(x.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|nl|in|com\.mx|com\.br|com\.au)\/[^.]*?(\/|[?&]ASIN=)([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/) || x.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|nl|in|com\.mx|com\.br|com\.au)\/(.*?)\/dp\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))\//) || 
      x.match(/^htt(p|ps):\/\/.*?\.amzn\.(com).*?\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/)) ? x.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|nl|es|in|com\.mx|com\.br|com\.au)\/[^.]*?\/(wishlist|registry)/) || x.match(/^htt(p|ps):\/\/w*?\.amzn\.(com)[^.]*?\/(wishlist|registry)/) || (x.match("^https?://.*?(?:seller).*?.amazon.(de|com|co.uk|co.jp|ca|fr|it|nl|es|in|com.mx|com.br|com.au)/") ? l("s" + f.getDomain(RegExp.$1)) : x.match(/^https?:\/\/.*?(?:af.?ilia|part|assoc).*?\.amazon\.(de|com|co\.uk|co\.jp|nl|ca|fr|it|es|in|com\.mx|com\.br|com\.au)\/home/) && 
      ...
      if (!A) {
        ...
        (I || x.match(l)) && document.addEventListener("DOMContentLoaded", function(a) {
          var b = null;
          chrome.runtime.sendMessage({type:"getFilters"}, function(a) {
            b = a;
            if (null != b && null != b.value) {
              var c = function() {
                var b = x.match("^https?://.*?.amazon.(de|com|co.uk|co.jp|ca|fr|it|es|in|com.br|nl|com.mx)/");
                if (I || b) {
        ...
        var w = {image_urls_main:[], pf_preview_current:"", preview_images:[], tld:"", img_string:'<img style="border: 1px solid #ff9f29;  -moz-border-radius: 0px;  margin: -3px;   display:block;   position: relative;   top: -3px;   left: -3px;" src=\'', createNewImageElement:function(a) {
          ...
          if (!w.pf_preview_current.firstChild) {
            ...
            h = "undefined" == typeof a ? h + "&amazon=1&new=1&used=1&salesrank=1&range=365" : h + ("&amazon=" + a[0] + "&new=" + a[1] + "&used=" + a[2] + "&salesrank=" + a[3] + "&range=" + b + "&fba=" + a[10] + "&fbm=" + a[7] + "&bb=" + a[18] + "&ld=" + a[8] + "&bbu=" + a[32] + "&pe=" + a[33] + "&wd=" + a[9]);
